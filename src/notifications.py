from src.base_functions import (
    ...
    remove_columns,
    rename_columns,
    add_url_with_single_null_handling
)


def get_notifications_data(instrument_code: str) -> dict:
    """
    ...
    base_url = "https://cdn.tsetmc.com/api/Codal/GetPreparedDataByInsCode/99999"

    # URL for downloading additional content based on TracingNo and RowOrder.
    download_url = 'https://cdn.tsetmc.com/api/Codal/GetAttachmentContentFileByTracingNoAndRowOrder'
