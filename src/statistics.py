...
def get_statistics_data(instrument_code: str) -> dict:
    ...
    try:
        ...
        parsed_data = data_to_js(raw_data, 'instrumentStatistic')
        ...
        add_inscode=update_column_values(cleaned_data_frame,'insCode',instrument_code)

        # Step 8: Convert the cleaned DataFrame back into JSON format.
        final_json_data = df_to_js(add_inscode)
